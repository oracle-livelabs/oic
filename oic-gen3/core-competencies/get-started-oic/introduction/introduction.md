...
This workshop will walk you through the steps to create an end-to-end integration of reading a file from the File Server and inserting the data set in an Oracle Autonomous AI  Lakehouse(LH) Table leveraging out of the box adapters.
...
- Oracle Autonomous Database(Lakehouse) Instance in Oracle Cloud Infrastructure
- A Chrome browser.
