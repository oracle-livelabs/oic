...
4. Run the agent
    a.  In the Agents card, find the AI agent to run: **Expense Agent**

    b.  Click **Actions icon**, and select *Run*.

5. Test the agent.
    a.  In the Test Agent page, click on the prompt text area, system will show you the prompt template you created, select it, and enter the *filename* and *directory* to test the AI agent and click on Submit.
...
4. System open *opa* workspace on new window, select the task assigned to you and approve it.
...
You have successfully completed the Autonomous Expense Agent AI Agent Live Lab!
