...
1. In the **Integrations** section, Click on **...** of the Integration **ERP Bulk Extract Callback** and click the **Activate** icon
...
1. In the **Integrations** section, click  on ***ERP Bulk Extract*** to edit the integration.
2. Select the action **Map InitiateExtract** and click on **...** and click on **Edit**
3. In the Target section successively expand the ***InitiateExtract Request*** element.
...
1. In the **Integrations** section, Click on **...** of the Integration ***ERP Bulk Extract*** and click on the ***Activate*** icon.
...
5. Click on ***Observe*** and ***Instances*** and Click on the Instance of ERP Bulk Extract and make a note of Process Id which is returned as a response from the activity stream.
