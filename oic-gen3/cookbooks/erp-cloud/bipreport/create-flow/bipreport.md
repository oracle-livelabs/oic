...
3. On the **Operations** page,
    ...
    * Click ***Continue***.
4. On the **Headers** page,
    * Click ***Continue***.
5. Review the summary and click ***Finish***
6. Click ***Save*** to persist changes
7. If required, click on Zoom out/in to view the complete flow.
...
1. In the **Integrations** section, Click on **...** of the Integration **Short BIP Report** and click the **Activate** icon
